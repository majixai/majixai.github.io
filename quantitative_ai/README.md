...
- `math/` → [`../math_index.md`](../math_index.md) and the core math directories such as [`../matrix/`](../matrix/), [`../calculus/`](../calculus/), [`../optimization/`](../optimization/), [`../numerical_methods/`](../numerical_methods/)
