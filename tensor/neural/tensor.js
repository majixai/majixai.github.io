/**
 * tensor.js — Canonical Tensor class with Adam optimizer
 *
 * This is the authoritative source for the lightweight Tensor primitive and
 * AdamOptimizer used by the neural-network layers throughout the repo.
 *
 * Consumers:
 *   - neural_tensor_network/tensor.js  (re-exports from here)
 *   - /tensor/neural/network.js        (imports directly)
 */
